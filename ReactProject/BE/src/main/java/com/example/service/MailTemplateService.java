...
import com.example.demo.repository.MailTemplateRepository;
...
public class MailTemplateService {
     ...
     * 全件取得
     */
    public List<MailTemplateModel> findAll() {
     ...
     */
    public MailTemplateModel saveOrUpdate(MailTemplateModel template) {
     ...
     */
    public Optional<MailTemplateModel> updateTemplate(String templateName, String locale, MailTemplateModel updatedData) {
        MailTemplateId id = new MailTemplateId(templateName, locale);
        Optional<MailTemplateModel> optional = mailTemplateRepository.findById(id);

        if (optional.isPresent()) {
            MailTemplateModel template = optional.get();
